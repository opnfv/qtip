...
class Driver:
    ...
    def run_ansible_playbook(self, benchmark, extra_vars):
        ...
        print extra_vars_json
        run_play = 'ansible-playbook ./benchmarks/playbooks/{0}.yaml  --private-key=./data/QtipKey -i ./data/hosts --extra-vars \'{1}\''.format(benchmark, extra_vars_json)
        os.system(run_play)
