...
def dpi_index():
    ...
    dpi_bm_index = get_index(dpi_dict, 'dpi_bm.yaml', dpi_bm_ref, 'details', 'bps')

    dpi_vm_ref = get_reference('compute', 'dpi_vm')
    dpi_vm_index = get_index(dpi_dict, 'dpi_vm.yaml', dpi_vm_ref, 'details', 'bps')
...
def dhrystone_index():
    ...
    dhrystone_single_bm_index = get_index(dhrystone_dict, 'dhrystone_bm.yaml', dhrystone_single_bm_ref, 'details', 'single', 'score')

    dhrystone_multi_bm_ref = get_reference('compute', 'dhrystone_bm', 'multi_cpu')
    dhrystone_multi_bm_index = get_index(dhrystone_dict, 'dhrystone_bm.yaml', dhrystone_multi_bm_ref, 'details', 'multi', 'score')
    ...
    dhrystone_single_vm_index = get_index(dhrystone_dict, 'dhrystone_vm.yaml', dhrystone_single_vm_ref, 'details', 'single', 'score')

    dhrystone_multi_vm_ref = get_reference('compute', 'dhrystone_vm', 'multi_cpu')
    dhrystone_multi_vm_index = get_index(dhrystone_dict, 'dhrystone_vm.yaml', dhrystone_multi_vm_ref, 'details', 'multi', 'score')
...
def whetstone_index():
    ...
    whetstone_single_bm_index = get_index(whetstone_dict, 'whetstone_bm.yaml', whetstone_single_bm_ref, 'details', 'single', 'score')

    whetstone_multi_bm_ref = get_reference('compute', 'whetstone_bm', 'multi_cpu')
    whetstone_multi_bm_index = get_index(whetstone_dict, 'whetstone_bm.yaml', whetstone_multi_bm_ref, 'details', 'multi', 'score')
    ...
    whetstone_single_vm_index = get_index(whetstone_dict, 'whetstone_vm.yaml', whetstone_single_vm_ref, 'details', 'single', 'score')

    whetstone_multi_vm_ref = get_reference('compute', 'whetstone_vm', 'multi_cpu')
    whetstone_multi_vm_index = get_index(whetstone_dict, 'whetstone_vm.yaml', whetstone_multi_vm_ref, 'details', 'multi', 'score')
...
def ramspeed_index():
    ...
    ramspeed_int_bm_index = get_index(ramspeed_dict, 'ramspeed_bm.yaml', ramspeed_int_bm_ref, 'details', 'int_bandwidth', 'average')

    ramspeed_float_bm_ref = get_reference('compute', 'ramspeed_bm', 'FLOATmem', 'Average (MB/s)')
    ramspeed_float_bm_index = get_index(ramspeed_dict, 'ramspeed_bm.yaml', ramspeed_float_bm_ref, 'details', 'float_bandwidth', 'average')
    ...
    ramspeed_int_vm_index = get_index(ramspeed_dict, 'ramspeed_vm.yaml', ramspeed_int_vm_ref, 'details', 'int_bandwidth', 'average')

    ramspeed_float_vm_ref = get_reference('compute', 'ramspeed_vm', 'FLOATmem', 'Average (MB/s)')
    ramspeed_float_vm_index = get_index(ramspeed_dict, 'ramspeed_vm.yaml', ramspeed_float_vm_ref, 'details', 'float_bandwidth', 'average')
...
def ssl_index():
    ...
    ssl_RSA512b_bm_index = get_index(ssl_dict, "ssl_bm.yaml", ssl_RSA512b_bm_ref, 'details', 'rsa_sig', '512_bits')
    ssl_RSA1024b_bm_index = get_index(ssl_dict, "ssl_bm.yaml", ssl_RSA1024b_bm_ref, 'details', 'rsa_sig', '1024_bits')
    ssl_RSA2048b_bm_index = get_index(ssl_dict, "ssl_bm.yaml", ssl_RSA2048b_bm_ref, 'details', 'rsa_sig', '2048_bits')
    ssl_RSA4096b_bm_index = get_index(ssl_dict, "ssl_bm.yaml", ssl_RSA4096b_bm_ref, 'details', 'rsa_sig', '4096_bits')
    ssl_RSA_bm_index = (ssl_RSA512b_bm_index + ssl_RSA1024b_bm_index + ssl_RSA2048b_bm_index + ssl_RSA4096b_bm_index) / 4

    ssl_AES16B_bm_index = get_index(ssl_dict, "ssl_bm.yaml", ssl_AES16B_bm_ref, 'details', 'aes_128_cbc', '16B_block')
    ssl_AES64B_bm_index = get_index(ssl_dict, "ssl_bm.yaml", ssl_AES64B_bm_ref, 'details', 'aes_128_cbc', '64B_block')
    ssl_AES256B_bm_index = get_index(ssl_dict, "ssl_bm.yaml", ssl_AES256B_bm_ref, 'details', 'aes_128_cbc', '256B_block')
    ssl_AES1024B_bm_index = get_index(ssl_dict, "ssl_bm.yaml", ssl_AES1024B_bm_ref, 'details', 'aes_128_cbc', '1024B_block')
    ssl_AES8192B_bm_index = get_index(ssl_dict, "ssl_bm.yaml", ssl_AES8192B_bm_ref, 'details', 'aes_128_cbc', '8192B_block')
    ...
    ssl_RSA512b_vm_index = get_index(ssl_dict, "ssl_vm.yaml", ssl_RSA512b_vm_ref, 'details', 'rsa_sig', '512_bits')
    ssl_RSA1024b_vm_index = get_index(ssl_dict, "ssl_vm.yaml", ssl_RSA1024b_vm_ref, 'details', 'rsa_sig', '1024_bits')
    ssl_RSA2048b_vm_index = get_index(ssl_dict, "ssl_vm.yaml", ssl_RSA2048b_vm_ref, 'details', 'rsa_sig', '2048_bits')
    ssl_RSA4096b_vm_index = get_index(ssl_dict, "ssl_vm.yaml", ssl_RSA4096b_vm_ref, 'details', 'rsa_sig', '4096_bits')
    ssl_RSA_vm_index = (ssl_RSA512b_vm_index + ssl_RSA1024b_vm_index + ssl_RSA2048b_vm_index + ssl_RSA4096b_vm_index) / 4

    ssl_AES16B_vm_index = get_index(ssl_dict, "ssl_vm.yaml", ssl_AES16B_vm_ref, 'details', 'aes_128_cbc', '16B_block')
    ssl_AES64B_vm_index = get_index(ssl_dict, "ssl_vm.yaml", ssl_AES64B_vm_ref, 'details', 'aes_128_cbc', '64B_block')
    ssl_AES256B_vm_index = get_index(ssl_dict, "ssl_vm.yaml", ssl_AES256B_vm_ref, 'details', 'aes_128_cbc', '256B_block')
    ssl_AES1024B_vm_index = get_index(ssl_dict, "ssl_vm.yaml", ssl_AES1024B_vm_ref, 'details', 'aes_128_cbc', '1024B_block')
    ssl_AES8192B_vm_index = get_index(ssl_dict, "ssl_vm.yaml", ssl_AES8192B_vm_ref, 'details', 'aes_128_cbc', '8192B_block')
