...
class StcvStack(object):
    ...
    def _make_parameters(self):
        ...
        return {
            ...
            # 'stcv_user_data': base64.encodestring(user_data)
            # 'stcv_config_file': self.STCV_CONFIG_FILE
    ...
    def create_stack(self):
        ...
        while True:
            ...
            if (status == u'CREATE_COMPLETE'):
                # self.stcv1_ip = stack.outputs[0]['output_value']
                # self.stcv2_ip = stack.outputs[1]['output_value']
                # self.stcv1_tst_ip = stack.outputs[2]['output_value'][0]['ip_address']
                # self.stcv2_tst_ip = stack.outputs[3]['output_value'][0]['ip_address']
