...
#			self.roles_ip_list.insert(offset,(Virtualtag[virtuallabel]['role'],Virtualtag[hostlabel]['ip']))
#			self.ip_pw_list.insert(offset,(Virtualtag[virtuallabel]['ip'],Virtualtag[hlabel]['pw']))
...
#			valid_file = validate_yaml.Validate_Yaml(doc)
			...
			return (self.benchmark, self.roles_dict.items(), self.vm_parameters)
