...
"pod_name": Pod name,default is 'default',

"suit_name": Test suite name,for example,compute,network,storage,all
default is 'all'
"type": BM or VM,default is 'BM'
    ...
    def post(self):
        ...
        parser.add_argument('suit_name', type=str, required=False, default='all', help='suit_name should be string')
