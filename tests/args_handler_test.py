...
class TestClass:
    ...
    def test_setup_test_env_bm_successful(self):
        ...
        env = func.args_handler.setup_test_env(test_case, 'fuel')
    ...
    def test_setup_test_env_failed(self):
        ...
        with pytest.raises(KeyError) as excinfo:
            func.args_handler.setup_test_env(test_case, 'fuel')
    ...
    def test_prepare_ansible_env_successful(self):
        ...
        benchmark, benchmark_details, proxy_info, env = \
            func.args_handler.prepare_ansible_env(test_case, 'fuel')
