...
@click.option('--opnfv-scenario',
              help='OPNFV scenario')
def create(project_name, project_template, pod_name, installer_type, installer_host, opnfv_scenario):
