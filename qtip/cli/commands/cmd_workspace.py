...
@click.option('--pod', help='Name of pod under test')
@click.option('--installer', help='OpenStack installer')
@click.option('--host', help='Installer hostname')
@click.option('--scenario', help='SDN scenario')
@click.argument('name')
def create(pod, installer, host, scenario, name):
    extra_vars = {
