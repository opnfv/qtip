    ...
    def __init__(self, args=sys.argv[1:]):
        ...
        if args.benchmark != 0:
          if not args_handler.check_benchmark_name(args.lab, args.file, args.benchmark):
            ...
            args_handler.prepare_and_run_benchmark(os.environ['INSTALLER_TYPE'], os.environ['PWD'],args_handler.get_benchmark_path	
	    (args.lab.lower(), args.file,args.benchmark))
