...
cmd="docker network create ${CONTAINER_NETWORK}"
...
docker_network="--netowrk ${CONTAINER_NETWORK}"

cmd="docker run -id ${envs} ${docker_volume} ${docker_network} opnfv/qtip:${DOCKER_TAG} /bin/bash"
echo "Qtip: Running docker command: ${cmd}"
${cmd}
